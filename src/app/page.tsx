      ...
      <div className="min-h-screen bg-black text-white overflow-x-hidden">
        ...
        <nav className="relative z-50 mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-bold tracking-tight">Kraft<span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">AI</span></span>
          </div>
        ...
        <section className="relative z-10 mx-auto max-w-6xl px-6 py-24 md:py-32">
          <div className="text-center">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-6">
              <span className="bg-gradient-to-r from-white via-purple-200 to-cyan-200 bg-clip-text text-transparent">You Think.</span>
              <br />
              <span className="bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent animate-gradient">We Build.</span>
              <br />
            ...
            <p className="text-xl md:text-2xl text-slate-400 max-w-3xl mx-auto mb-10 leading-relaxed">
              From idea to deployed product — websites, apps, stores, anything. <span className="text-white font-medium">Free consultation</span>. <span className="text-cyan-400">Fair pricing</span>. <span className="text-purple-400">Trusted delivery</span>.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a href="https://wa.me/918859820935?text=Hi! I have an idea I want to discuss..." target="_blank" rel="noopener noreferrer" className="group inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full font-semibold text-lg overflow-hidden hover:scale-105 transition-transform">
                <MessageCircle className="w-5 h-5" /> Chat on WhatsApp
              </a>
              <a href="mailto:hritikchaudhary016@gmail.com?subject=Project Inquiry" className="group inline-flex items-center gap-3 px-8 py-4 bg-white/5 border border-white/10 rounded-full font-semibold text-lg hover:bg-white/10 transition-all hover:border-white/20">
        ...
        <section id="services" className="relative z-10 py-24 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-400 text-sm mb-4"><Zap className="w-4 h-4" /> What We Build</div>
              <h2 className="text-4xl md:text-6xl font-bold mb-4"><span className="bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">Anything</span><span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent"> You Need</span></h2>
              <p className="text-slate-400 text-lg max-w-2xl mx-auto">From a simple idea to a fully deployed product. We build it all.</p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {services.map((service, idx) => (
                <Link key={idx} href={service.href} className="group relative p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-purple-500/50 transition-all duration-500 hover:-translate-y-2 overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-purple-500/20 to-cyan-500/20 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300"><service.icon className="w-7 h-7 text-purple-400" /></div>
                    <h3 className="text-xl font-bold mb-2 text-white group-hover:text-cyan-400 transition-colors">{service.title}</h3>
                    <p className="text-slate-400">{service.desc}</p>
                    <div className="mt-6 flex items-center text-sm text-purple-400 opacity-0 group-hover:opacity-100 transition-all transform translate-y-2 group-hover:translate-y-0"><span>Learn more</span><ChevronRight className="w-4 h-4 ml-1" /></div>
                  </div>
        ...
        <section id="process" className="relative z-10 py-24 px-6 bg-gradient-to-b from-transparent via-purple-950/20 to-transparent">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 text-sm mb-4"><Layers className="w-4 h-4" /> How It Works</div>
              <h2 className="text-4xl md:text-6xl font-bold mb-4"><span className="bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">From</span><span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent"> Thought</span><span className="bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent"> to</span><span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent"> Product</span></h2>
            </div>
            <div className="grid md:grid-cols-4 gap-6">
              {process.map((step, idx) => (
                <div key={idx} className="relative text-center p-8">
                  {idx < process.length - 1 && <div className="hidden md:block absolute top-16 left-[60%] w-[80%] h-px bg-gradient-to-r from-purple-500/50 to-cyan-500/50" />}
                  <div className="relative inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500 to-cyan-500 mb-6"><span className="text-2xl font-bold">{step.num}</span></div>
        ...
        <section className="relative z-10 py-24 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-pink-500/10 border border-pink-500/20 text-pink-400 text-sm mb-4"><Shield className="w-4 h-4" /> Why Choose Us</div>
                <h2 className="text-4xl md:text-5xl font-bold mb-6"><span className="bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent">We Turn</span><br /><span className="bg-gradient-to-r from-pink-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent">Ideas Into Reality</span></h2>
                <div className="space-y-4">
                  {["Free consultation - unique in the industry", "On-time delivery you can trust", "Fair & transparent pricing", "End-to-end development & deployment", "You own everything we build"].map((item, idx) => (
                    <div key={idx} className="flex items-center gap-3"><div className="w-6 h-6 rounded-full bg-green-500/20 flex items-center justify-center"><CheckCircle className="w-4 h-4 text-green-400" /></div><span className="text-slate-300">{item}</span></div>
                  ))}
                </div>
              </div>
              <div className="relative">
                <div className="relative p-8 rounded-3xl bg-gradient-to-br from-purple-900/50 via-slate-900/80 to-cyan-900/50 border border-white/10 backdrop-blur-xl">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-slate-300 mb-6">Share your idea with us and watch it become reality.</p>
                    <div className="flex flex-col gap-3">
                      <a href="https://wa.me/918859820935?text=Hi! I have an idea I want to discuss..." target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-green-500 hover:bg-green-400 rounded-full font-semibold transition-all hover:scale-105"><MessageCircle className="w-5 h-5" /> WhatsApp Now</a>
                      <a href="mailto:hritikchaudhary016@gmail.com?subject=Project Inquiry" className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white/10 border border-white/20 hover:bg-white/20 rounded-full font-semibold transition-all"><Mail className="w-5 h-5" /> Email Me</a>
                    </div>
                  </div>
                </div>
                <div className="absolute -top-4 -right-4 px-4 py-2 rounded-full bg-cyan-500/20 border border-cyan-500/40 text-cyan-400 text-sm animate-pulse"><span className="flex items-center gap-2"><Zap className="w-3 h-3" /> Fast Response</span></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="relative z-10 py-24 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12"><h2 className="text-3xl md:text-5xl font-bold"><span className="bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">Our</span><span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent"> Products</span></h2></div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {products.map((product) => (
                <Link key={product.name} href={product.href} className="group relative p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-purple-500/50 transition-all hover:-translate-y-1">
                  <div className={`inline-flex p-3 rounded-xl ${product.bgColor} mb-4`}><product.icon className={`h-6 w-6 ${product.color}`} /></div>
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="text-lg font-semibold text-white">{product.name}</h3>
                    <span className={`text-xs px-2 py-1 rounded-full ${product.status === "Live" ? "bg-green-500/20 text-green-400" : product.status === "New" ? "bg-blue-500/20 text-blue-400" : "bg-slate-500/20 text-slate-400"}`}>{product.status}</span>
                  </div>
        ...
        <section className="relative z-10 py-24 px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="p-12 rounded-3xl bg-gradient-to-br from-purple-900/40 via-slate-900/80 to-cyan-900/40 border border-white/10 backdrop-blur-xl">
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-4"><span className="bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent">Have an</span><span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent"> Idea?</span></h2>
              <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">Think about it. Tell us about it. We'll build, deploy, and give you the ready-made product.</p>
              <a href="https://wa.me/918859820935?text=Hi! I have an idea I want to discuss..." target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-green-500 hover:bg-green-400 rounded-full font-semibold text-lg transition-all hover:scale-105"><MessageCircle className="w-5 h-5" /> Get Free Consultation</a>
            </div>
          </div>
        </section>
        ...
        <footer className="relative z-10 border-t border-white/10 py-12">
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-2"><Hexagon className="w-6 h-6 text-purple-400 fill-purple-400/20" /><span className="font-bold">KraftAI</span></div>

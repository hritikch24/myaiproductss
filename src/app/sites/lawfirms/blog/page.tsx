...
export function generateMetadata(): Metadata {
  return generateNicheMetadata({
    title: `Blog | AI Automation for Personal Injury Law Firms | KraftAI`,
    description:
      'Practical guides and insights on automating client intake, reducing status calls, and growing your personal injury law firm with AI-powered workflows.',
    keywords: [
      ...niche.keywords,
      'personal injury law blog',
      'law firm automation tips',
      'PI firm growth strategies',
    ],
...
export default function LawfirmsBlogPage() {
  return (
    <>
      <script
    ...
    <section className="bg-slate-950 py-16 sm:py-20" aria-labelledby="blog-listing-heading">
      <div className="mx-auto max-w-6xl px-6">
        <header className="text-center mb-12">
          ...
          >
            KraftAI Blog for Law Firms
          </h1>
          <p className="mt-4 text-slate-400 max-w-2xl mx-auto">
            Expert guides on using AI automation to sign more cases, reduce
            administrative overhead, and deliver a better client experience at
            your personal injury firm.
          </p>
        </header>
        ...
        <div className="mt-16 text-center">
          <p className="text-slate-400 mb-4">
            Ready to see how automation can transform your PI firm?
          </p>
          <Link
            href="/#lead-form"

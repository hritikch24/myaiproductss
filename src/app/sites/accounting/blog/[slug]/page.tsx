...
export default async function AccountingBlogPostPage({ params }: PageProps) {
  const { slug } = await params;
        ...
        <div className="mx-auto max-w-3xl px-6">
          ...
          <aside className="mt-14 rounded-2xl border border-indigo-500/30 bg-gradient-to-b from-slate-900 to-slate-950 p-8 text-center">
            ...
            <p className="text-slate-400 mb-6 max-w-lg mx-auto">
              Stop chasing documents and missing deadlines. See how AI can help
              your accounting firm serve more clients with less effort.
            </p>
            <Link
              href="/#lead-form"

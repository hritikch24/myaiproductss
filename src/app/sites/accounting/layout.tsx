...
export default function AccountingLayout({ children }: { children: ReactNode }) {
  return (
    <>
      ...
      <ExitIntentPopup headline="Wait — don't leave money on the table" subtext="Get a free automation audit showing how much time you're wasting on manual bookkeeping. 30 minutes, zero obligation." />

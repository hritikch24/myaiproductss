...
export function generateMetadata(): Metadata {
  return generateNicheMetadata({
    title: `Blog - AI Automation for Staffing Agencies | KraftAI`,
    description: `Expert insights on AI automation for staffing and recruiting agencies. Learn how to reduce time-to-fill, automate candidate outreach, and scale your placements.`,
    keywords: [
...
export default function StaffingBlogPage() {
  return (
    <>
      <section className="bg-gradient-to-b from-slate-950 to-slate-900 py-20 sm:py-24" aria-labelledby="blog-heading">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <h1 id="blog-heading" className="text-4xl font-bold text-white sm:text-5xl">
            Staffing & Recruiting Insights
          </h1>
          <p className="mt-4 text-lg text-slate-400 max-w-2xl">
            Actionable guides and strategies to help staffing agencies automate workflows, place candidates faster, and grow revenue with AI.
          </p>
        </div>
      </section>

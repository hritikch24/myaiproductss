...
export default async function StaffingBlogPostPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
        ...
        <div className="mx-auto max-w-3xl px-6">
          ...
          <aside className="mt-14 rounded-2xl border border-indigo-500/30 bg-gradient-to-r from-indigo-950/50 to-slate-900 p-6 sm:p-8 text-center">
            <h2 className="text-xl font-bold text-white">
              Ready to automate your staffing workflow?
            </h2>
            <p className="mt-2 text-sm text-slate-400">
              See how KraftAI can help your agency fill roles faster and place more candidates.
            </p>
            <a
              href="/#lead-form"
